    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        for idx, val_data in enumerate(dataloader):
            ...
            if 'gt' in visuals:
                ...
                # resize sr_img to gt_img size for metric calculation
                sr_img_resized = cv2.resize(sr_img, (gt_img.shape[1], gt_img.shape[0]), interpolation=cv2.INTER_LINEAR)
                metric_data['img'] = sr_img_resized
